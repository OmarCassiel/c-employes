        ...
        function validarCorreo() {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response === "si") {
                        $('#yaUsado').html('El correo ' + correo + ' ya esta registrado');
...
<form name="Forma01" id="Forma01" enctype="multipart/form-data" >
    <header><h1>ALTA EMPLEADO</h1></header>
    <hr>
    ...
    <input type="text" name="correo" id="correo" placeholder="@" onBlur="validarCorreo();" /> <br>
    <div id="yaUsado"></div>
    <input type="text" name="pass" id="pass" placeholder="Escribe tu pass" /> <br>
